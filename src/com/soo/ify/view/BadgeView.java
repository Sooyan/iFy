...
public class BadgeView extends TextView {
    ...
    private void applyTo(View target) {
        ...
        if (target instanceof TabWidget) {
            ...
            container.addView(target, new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT));
    ...
    private void applyLayoutParams() {
        ...
        if (parent instanceof LinearLayout) {
            ...
            linParams.gravity = lp.gravity;
            linParams.setMargins(lp.leftMargin, lp.topMargin, lp.rightMargin, lp.bottomMargin);
            setLayoutParams(linParams);
            ...
            reParams.setMargins(lp.leftMargin, lp.topMargin, lp.rightMargin, lp.bottomMargin);
