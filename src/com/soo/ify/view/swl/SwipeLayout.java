...
public class SwipeLayout extends FrameLayout {
    ...
    private LinkedHashMap<DragEdge, View> mDragEdges = new LinkedHashMap<SwipeLayout.DragEdge, View>();
    private ShowMode mShowMode;

    private float[] mEdgeSwipesOffset = new float[4];

    private List<SwipeListener> mSwipeListeners = new ArrayList<SwipeLayout.SwipeListener>();
    private List<SwipeDenier> mSwipeDeniers = new ArrayList<SwipeLayout.SwipeDenier>();
     ...
     * {@link com.soo.swallow.view.sml.daimajia.swipe.SwipeLayout.OnRevealListener}
     *
     ...
     * @param l        the {@link com.soo.swallow.view.sml.daimajia.swipe.SwipeLayout.OnRevealListener}
     */
    ...
    public interface OnLayout {
        void onSwipeLayout(SwipeLayout v);
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (mOnLayoutListeners != null) for (int i = 0; i < mOnLayoutListeners.size(); i++) {
            mOnLayoutListeners.get(i).onSwipeLayout(this);
        }
    }
     ...
     * {@link com.soo.swallow.view.sml.daimajia.swipe.SwipeLayout.ShowMode}.PullOut and
     * {@link com.soo.swallow.view.sml.daimajia.swipe.SwipeLayout.ShowMode}.LayDown.
     *
     * @param mode
     */
     ...
     * get the open status.
     *
     * @return {@link com.soo.swallow.view.sml.daimajia.swipe.SwipeLayout.Status} Open , Close or
     * Middle.
     */
